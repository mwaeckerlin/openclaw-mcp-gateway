...
export const READONLY_RPC_TOOL_DEFINITIONS: Array<{
  ...
  { name: "openclaw_channels_status", description: "Channel runtime status, optionally with probes.", inputSchema: { type: "object", properties: { probe: { type: "boolean" }, timeoutMs: { type: "integer", minimum: 500, maximum: 120000 } }, additionalProperties: false } },
  { name: "openclaw_channels_capabilities", description: "Channel capability hints and permissions.", inputSchema: { type: "object", properties: { channel: { type: "string", minLength: 1 }, account: { type: "string", minLength: 1 }, target: { type: "string", minLength: 1 } }, additionalProperties: false } },
  { name: "openclaw_channels_resolve", description: "Resolve channel names/mentions to IDs.", inputSchema: { type: "object", properties: { entries: { type: "array", items: { type: "string" }, minItems: 1, maxItems: 50 }, channel: { type: "string", minLength: 1 }, account: { type: "string", minLength: 1 }, kind: { enum: ["auto", "user", "group"] } }, required: ["entries"], additionalProperties: false } },
  { name: "openclaw_channels_logs", description: "Bounded filtered channel logs with redaction.", inputSchema: { type: "object", properties: { channel: { type: "string", minLength: 1 }, lines: { type: "integer", minimum: 1, maximum: 5000 } }, additionalProperties: false } },
  { name: "openclaw_plugins_list", description: "Plugin inventory.", inputSchema: { type: "object", properties: { enabledOnly: { type: "boolean" }, verbose: { type: "boolean" } }, additionalProperties: false } },
  { name: "openclaw_plugins_inspect", description: "Inspect one plugin.", inputSchema: { type: "object", properties: { id: { type: "string", minLength: 1 } }, required: ["id"], additionalProperties: false } },
  { name: "openclaw_plugins_doctor", description: "Plugin diagnostics (read-only).", inputSchema: { type: "object", properties: {}, additionalProperties: false } },
  { name: "openclaw_models_status", description: "Model/provider auth status and probes.", inputSchema: { type: "object", properties: { check: { type: "boolean" }, probe: { type: "boolean" }, probeProvider: { type: "string", minLength: 1 }, probeProfileIds: { type: "array", items: { type: "string" }, maxItems: 50 }, probeTimeoutMs: { type: "integer", minimum: 1000, maximum: 120000 }, probeConcurrency: { type: "integer", minimum: 1, maximum: 32 }, probeMaxTokens: { type: "integer", minimum: 1, maximum: 32000 }, agentId: { type: "string", minLength: 1 } }, additionalProperties: false } },
  { name: "openclaw_models_list", description: "List available models.", inputSchema: { type: "object", properties: { agentId: { type: "string", minLength: 1 } }, additionalProperties: false } },
  { name: "openclaw_models_aliases_list", description: "List model aliases.", inputSchema: { type: "object", properties: {}, additionalProperties: false } },
  { name: "openclaw_models_fallbacks_list", description: "List model fallbacks.", inputSchema: { type: "object", properties: {}, additionalProperties: false } },
  { name: "openclaw_config_get", description: "Read one config path (secret paths blocked).", inputSchema: { type: "object", properties: { path: { type: "string", minLength: 1 } }, required: ["path"], additionalProperties: false } },
  { name: "openclaw_config_file", description: "Active config file path.", inputSchema: { type: "object", properties: {}, additionalProperties: false } },
  { name: "openclaw_config_validate", description: "Read-only config validation result.", inputSchema: { type: "object", properties: {}, additionalProperties: false } },
  { name: "openclaw_config_schema", description: "Full config schema.", inputSchema: { type: "object", properties: {}, additionalProperties: false } },
  { name: "openclaw_config_schema_lookup", description: "Schema metadata for one path.", inputSchema: { type: "object", properties: { path: { type: "string", minLength: 1 } }, required: ["path"], additionalProperties: false } },
  { name: "openclaw_security_audit", description: "Read-only security audit (no fix).", inputSchema: { type: "object", properties: { deep: { type: "boolean" } }, additionalProperties: false } },
  { name: "openclaw_secrets_audit", description: "Read-only secrets audit with redaction.", inputSchema: { type: "object", properties: { allowExec: { type: "boolean" }, check: { type: "boolean" } }, additionalProperties: false } },
  { name: "openclaw_approvals_get", description: "Effective exec approvals snapshot.", inputSchema: { type: "object", properties: { target: { enum: ["local", "gateway", "node"] }, node: { type: "string", minLength: 1 } }, additionalProperties: false } },
  { name: "openclaw_devices_list", description: "Pending and paired devices (tokens redacted).", inputSchema: { type: "object", properties: {}, additionalProperties: false } },
  { name: "openclaw_nodes_list", description: "Node list with optional filters.", inputSchema: { type: "object", properties: { connectedOnly: { type: "boolean" }, lastConnected: { type: "string", minLength: 1 } }, additionalProperties: false } },
  { name: "openclaw_nodes_pending", description: "Pending node pairing requests.", inputSchema: { type: "object", properties: {}, additionalProperties: false } },
  { name: "openclaw_nodes_status", description: "Node status view with optional filters.", inputSchema: { type: "object", properties: { connectedOnly: { type: "boolean" }, lastConnected: { type: "string", minLength: 1 } }, additionalProperties: false } },
  { name: "openclaw_skills_check", description: "Skill readiness check.", inputSchema: { type: "object", properties: {}, additionalProperties: false } },
  { name: "openclaw_sandbox_explain", description: "Explain effective sandbox policy.", inputSchema: { type: "object", properties: { sessionKey: { type: "string", minLength: 1 }, agentId: { type: "string", minLength: 1 } }, additionalProperties: false } },
  { name: "openclaw_sandbox_list", description: "List sandbox runtimes.", inputSchema: { type: "object", properties: { browserOnly: { type: "boolean" } }, additionalProperties: false } },
  { name: "openclaw_system_presence", description: "Current gateway system presence entries.", inputSchema: { type: "object", properties: {}, additionalProperties: false } }
];
